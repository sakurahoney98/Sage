package br.ucsal.sage.calendario.util;
...
public class DatePicker extends JPanel {
	 ...
	 * Construtor
	 * 
	 * @param cal   - CalendarView from where this is opening from
	 * @param day   Current day, use zero to show current day
	 * @param month Current month (Can be zero if day is zero two)
	 * @param year  Current year (Can be zero if day is zero two)
	 */
