 ...
 * @author Suporte TI
 */
public class TakeRequestView2 extends javax.swing.JFrame {
	...
	public TakeRequestView2() throws SQLException {
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(TakeRequestView2.class.getName()).log(java.util.logging.Level.SEVERE,
					null, ex);
		...
		java.awt.EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					new TakeRequestView2().setVisible(true);
				} catch (SQLException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
